...
import { controleAcessoRoutes } from 'app/modules/admin/pages/administrador/controle-acesso/controle-acesso.routing';
...
@NgModule({
    ...
    imports     : [
        RouterModule.forChild(controleAcessoRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
